...
import oversizedItems from "../../data/oversized.json";
import "swiper/css";
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 font-poppins">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-90 flex items-center justify-center p-4 animate-fadeIn">
                  <div className="text-center space-y-3">
                    ...
                    >
                      ...
                      <span>WhatsApp: 86046 03379</span>
                    </a>
                    <a
      ...
      <div className="text-center mt-12">
        <Link to="/oversized" className="bg-indigo-600 text-white px-8 py-3 rounded-full font-medium hover:bg-indigo-700 transition-all shadow-md">
          View All Oversized Products
        </Link>
      </div>
    </div>
  );
